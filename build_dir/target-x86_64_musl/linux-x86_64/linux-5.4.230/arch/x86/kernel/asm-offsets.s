	.file	"asm-offsets.c"
# GNU C89 (OpenWrt GCC 8.4.0 r19883-70b94249fa) version 8.4.0 (x86_64-openwrt-linux-musl)
...
# -idirafter /home/trb/sdk/imm/staging_dir/target-x86_64_musl/usr/include
...
# -isystem /home/trb/sdk/imm/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/lib/gcc/x86_64-openwrt-linux-musl/8.4.0/include
...
# -fmacro-prefix-map=./=
# -fmacro-prefix-map=/home/trb/sdk/imm/build_dir/target-x86_64_musl=target-x86_64_musl
...
.ascii "->TASK_stack_canary $1032 offsetof(struct task_struct, stack_canary)"	#
# 0 "" 2
...
.ascii "->TASK_addr_limit $2392 offsetof(struct task_struct, thread.addr_limit)"	#
# 0 "" 2
...
#NO_APP
	...
	ret	
	.size	common, .-common
	.ident	"GCC: (OpenWrt GCC 8.4.0 r19883-70b94249fa) 8.4.0"
