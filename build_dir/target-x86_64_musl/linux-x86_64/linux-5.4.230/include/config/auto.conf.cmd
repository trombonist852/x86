...
ifneq "$(KERNELVERSION)" "5.4.230"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "x86_64-openwrt-linux-musl-gcc (OpenWrt GCC 8.4.0 r19883-70b94249fa) 8.4.0"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "x86_64-openwrt-linux-musl-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "x86_64-openwrt-linux-musl-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "x86_64-openwrt-linux-musl-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "x86_64-openwrt-linux-musl-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "x86"
include/config/auto.conf: FORCE
