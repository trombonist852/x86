	.file	"asm-offsets.c"
# GNU C89 (OpenWrt GCC 8.4.0 r19085-9a6b44849d) version 8.4.0 (x86_64-openwrt-linux-musl)
...
# -idirafter /home/wangjun/21/staging_dir/target-x86_64_musl/usr/include
...
# -isystem /home/wangjun/21/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/lib/gcc/x86_64-openwrt-linux-musl/8.4.0/include
...
# -fshort-wchar -fno-PIE -fcf-protection=none -falign-jumps=1
...
# -fmacro-prefix-map=/home/wangjun/21/build_dir/target-x86_64_musl=target-x86_64_musl
...
# -mieee-fp -mindirect-branch-register -mlong-double-80 -mmusl
...
.ascii "->TASK_threadsp $2200 offsetof(struct task_struct, thread.sp)"	#
# 0 "" 2
# arch/x86/kernel/asm-offsets.c:37: 	OFFSET(TASK_stack_canary, task_struct, stack_canary);
# 37 "arch/x86/kernel/asm-offsets.c" 1
	
.ascii "->TASK_stack_canary $1024 offsetof(struct task_struct, stack_canary)"	#
# 0 "" 2
...
.ascii "->TASK_addr_limit $2328 offsetof(struct task_struct, thread.addr_limit)"	#
# 0 "" 2
