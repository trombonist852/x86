...
enum opt_code
{
  ...
  OPT_mandroid = 1214,                       /* -mandroid */
  OPT_march_ = 1215,                         /* -march= */
  OPT_masm_ = 1216,                          /* -masm= */
  OPT_mavx = 1217,                           /* -mavx */
  OPT_mavx2 = 1218,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1219,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1220,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1221,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1222,                  /* -mavx5124vnniw */
  OPT_mavx512bitalg = 1223,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1224,                      /* -mavx512bw */
  OPT_mavx512cd = 1225,                      /* -mavx512cd */
  OPT_mavx512dq = 1226,                      /* -mavx512dq */
  OPT_mavx512er = 1227,                      /* -mavx512er */
  OPT_mavx512f = 1228,                       /* -mavx512f */
  OPT_mavx512ifma = 1229,                    /* -mavx512ifma */
  OPT_mavx512pf = 1230,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1231,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1232,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1233,                      /* -mavx512vl */
  OPT_mavx512vnni = 1234,                    /* -mavx512vnni */
  OPT_mavx512vpopcntdq = 1235,               /* -mavx512vpopcntdq */
  OPT_mbionic = 1236,                        /* -mbionic */
  OPT_mbmi = 1237,                           /* -mbmi */
  OPT_mbmi2 = 1238,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1239,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1240,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1241,                    /* -mcet-switch */
  OPT_mcld = 1242,                           /* -mcld */
  OPT_mclflushopt = 1243,                    /* -mclflushopt */
  OPT_mclwb = 1244,                          /* -mclwb */
  OPT_mclzero = 1245,                        /* -mclzero */
  OPT_mcmodel_ = 1246,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1247, */                    /* -mcpu= */
  OPT_mcrc32 = 1248,                         /* -mcrc32 */
  OPT_mcx16 = 1249,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1250,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1251,            /* -mdump-tune-features */
  OPT_mf16c = 1252,                          /* -mf16c */
  OPT_mfancy_math_387 = 1253,                /* -mfancy-math-387 */
  OPT_mfentry = 1254,                        /* -mfentry */
  OPT_mfma = 1255,                           /* -mfma */
  OPT_mfma4 = 1256,                          /* -mfma4 */
  OPT_mforce_drap = 1257,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1258,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1259,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1260,                       /* -mfpmath= */
  OPT_mfsgsbase = 1261,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1262,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1263, */              /* -mfused-madd */
  OPT_mfxsr = 1264,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1265,             /* -mgeneral-regs-only */
  OPT_mgfni = 1266,                          /* -mgfni */
  OPT_mglibc = 1267,                         /* -mglibc */
  ...
  OPT_mmusl = 1293,                          /* -mmusl */
  OPT_mmwaitx = 1294,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1295,            /* -mno-align-stringops */
  OPT_mno_default = 1296,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1297,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1298,                  /* -mno-push-args */
  OPT_mno_red_zone = 1299,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1300,                       /* -mno-sse4 */
  ...
  OPT_mpku = 1309,                           /* -mpku */
  OPT_mpopcnt = 1310,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1311, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1312,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1313,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1314,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1315,                        /* -mprfchw */
  OPT_mpush_args = 1316,                     /* -mpush-args */
  OPT_mrdpid = 1317,                         /* -mrdpid */
  OPT_mrdrnd = 1318,                         /* -mrdrnd */
  OPT_mrdseed = 1319,                        /* -mrdseed */
  OPT_mrecip = 1320,                         /* -mrecip */
  OPT_mrecip_ = 1321,                        /* -mrecip= */
  OPT_mrecord_mcount = 1322,                 /* -mrecord-mcount */
  OPT_mred_zone = 1323,                      /* -mred-zone */
  OPT_mregparm_ = 1324,                      /* -mregparm= */
  OPT_mrtd = 1325,                           /* -mrtd */
  OPT_mrtm = 1326,                           /* -mrtm */
  OPT_msahf = 1327,                          /* -msahf */
  OPT_msgx = 1328,                           /* -msgx */
  OPT_msha = 1329,                           /* -msha */
  OPT_mshstk = 1330,                         /* -mshstk */
  OPT_mskip_rax_setup = 1331,                /* -mskip-rax-setup */
  OPT_msoft_float = 1332,                    /* -msoft-float */
  OPT_msse = 1333,                           /* -msse */
  OPT_msse2 = 1334,                          /* -msse2 */
  OPT_msse2avx = 1335,                       /* -msse2avx */
  OPT_msse3 = 1336,                          /* -msse3 */
  OPT_msse4 = 1337,                          /* -msse4 */
  OPT_msse4_1 = 1338,                        /* -msse4.1 */
  OPT_msse4_2 = 1339,                        /* -msse4.2 */
  OPT_msse4a = 1340,                         /* -msse4a */
  /* OPT_msse5 = 1341, */                    /* -msse5 */
  OPT_msseregparm = 1342,                    /* -msseregparm */
  OPT_mssse3 = 1343,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1344,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1345, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1346,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1347, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1348,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1349,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1350,            /* -mstringop-strategy= */
  OPT_mstv = 1351,                           /* -mstv */
  OPT_mtbm = 1352,                           /* -mtbm */
  OPT_mtls_dialect_ = 1353,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1354,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1355,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1356,                         /* -mtune= */
  OPT_muclibc = 1357,                        /* -muclibc */
  OPT_mvaes = 1358,                          /* -mvaes */
  OPT_mveclibabi_ = 1359,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1360,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1361,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1362,                    /* -mvzeroupper */
  OPT_mwbnoinvd = 1363,                      /* -mwbnoinvd */
  OPT_mx32 = 1364,                           /* -mx32 */
  OPT_mxop = 1365,                           /* -mxop */
  OPT_mxsave = 1366,                         /* -mxsave */
  OPT_mxsavec = 1367,                        /* -mxsavec */
  OPT_mxsaveopt = 1368,                      /* -mxsaveopt */
  OPT_mxsaves = 1369,                        /* -mxsaves */
  OPT_n = 1370,                              /* -n */
  OPT_no_canonical_prefixes = 1371,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1372,              /* -no-integrated-cpp */
  OPT_no_pie = 1373,                         /* -no-pie */
  OPT_nocpp = 1374,                          /* -nocpp */
  OPT_nodefaultlibs = 1375,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1376,                   /* -nostartfiles */
  OPT_nostdinc = 1377,                       /* -nostdinc */
  OPT_nostdinc__ = 1378,                     /* -nostdinc++ */
  OPT_nostdlib = 1379,                       /* -nostdlib */
  OPT_o = 1380,                              /* -o */
  OPT_p = 1381,                              /* -p */
  OPT_pass_exit_codes = 1382,                /* -pass-exit-codes */
  /* OPT_pedantic = 1383, */                 /* -pedantic */
  OPT_pedantic_errors = 1384,                /* -pedantic-errors */
  OPT_pg = 1385,                             /* -pg */
  OPT_pie = 1386,                            /* -pie */
  OPT_pipe = 1387,                           /* -pipe */
  OPT_posix = 1388,                          /* -posix */
  OPT_print_file_name_ = 1389,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1390,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1391,          /* -print-multi-directory */
  OPT_print_multi_lib = 1392,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1393,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1394,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1395,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1396,               /* -print-prog-name= */
  OPT_print_search_dirs = 1397,              /* -print-search-dirs */
  OPT_print_sysroot = 1398,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1399,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1400,                        /* -profile */
  OPT_pthread = 1401,                        /* -pthread */
  OPT_quiet = 1402,                          /* -quiet */
  OPT_r = 1403,                              /* -r */
  OPT_rdynamic = 1404,                       /* -rdynamic */
  OPT_remap = 1405,                          /* -remap */
  OPT_s = 1406,                              /* -s */
  OPT_save_temps = 1407,                     /* -save-temps */
  OPT_save_temps_ = 1408,                    /* -save-temps= */
  OPT_shared = 1409,                         /* -shared */
  OPT_shared_libgcc = 1410,                  /* -shared-libgcc */
  ...
  OPT_static_libstdc__ = 1421,               /* -static-libstdc++ */
  OPT_static_libtsan = 1422,                 /* -static-libtsan */
  OPT_static_libubsan = 1423,                /* -static-libubsan */
  OPT_static_pie = 1424,                     /* -static-pie */
  /* OPT_std_c__03 = 1425, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1426, */                /* -std=c++0x */
  OPT_std_c__11 = 1427,                      /* -std=c++11 */
  OPT_std_c__14 = 1428,                      /* -std=c++14 */
  OPT_std_c__17 = 1429,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1430, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1431, */                /* -std=c++1z */
  OPT_std_c__2a = 1432,                      /* -std=c++2a */
  OPT_std_c__98 = 1433,                      /* -std=c++98 */
  OPT_std_c11 = 1434,                        /* -std=c11 */
  OPT_std_c17 = 1435,                        /* -std=c17 */
  /* OPT_std_c18 = 1436, */                  /* -std=c18 */
  /* OPT_std_c1x = 1437, */                  /* -std=c1x */
  /* OPT_std_c89 = 1438, */                  /* -std=c89 */
  OPT_std_c90 = 1439,                        /* -std=c90 */
  OPT_std_c99 = 1440,                        /* -std=c99 */
  /* OPT_std_c9x = 1441, */                  /* -std=c9x */
  OPT_std_f2003 = 1442,                      /* -std=f2003 */
  OPT_std_f2008 = 1443,                      /* -std=f2008 */
  OPT_std_f2008ts = 1444,                    /* -std=f2008ts */
  OPT_std_f2018 = 1445,                      /* -std=f2018 */
  OPT_std_f95 = 1446,                        /* -std=f95 */
  OPT_std_gnu = 1447,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1448, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1449, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1450,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1451,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1452,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1453, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1454, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1455,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1456,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1457,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1458,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1459, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1460, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1461, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1462,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1463,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1464, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1465, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1466,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1467, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1468, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1469, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1470, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1471, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1472,                     /* -std=legacy */
  OPT_symbolic = 1473,                       /* -symbolic */
  OPT_t = 1474,                              /* -t */
  OPT_time = 1475,                           /* -time */
  OPT_time_ = 1476,                          /* -time= */
  OPT_tno_android_cc = 1477,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1478,                 /* -tno-android-ld */
  OPT_traditional = 1479,                    /* -traditional */
  OPT_traditional_cpp = 1480,                /* -traditional-cpp */
  OPT_trigraphs = 1481,                      /* -trigraphs */
  OPT_u = 1482,                              /* -u */
  OPT_undef = 1483,                          /* -undef */
  OPT_v = 1484,                              /* -v */
  OPT_version = 1485,                        /* -version */
  OPT_w = 1486,                              /* -w */
  OPT_wrapper = 1487,                        /* -wrapper */
  OPT_x = 1488,                              /* -x */
  OPT_z = 1489,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
